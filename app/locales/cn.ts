...
const cn = {
  WIP: "本站所有网址资源全部收集于互联网，分享目的仅供作为导航使用，如有侵权，请联系QQ:2033604371本站将会及时删除！本站文章、图文资源不保证其完整性和安全性，下载后请自行检测安全，在使用过程中出现的任何问题均与本站无关，请自行处理！本站所有资源您必须在下载后24小时内从您的设备上彻底删除，如果您喜欢该资源，请支持正版，购买注册，以便获得更好的服务和正规授权本站所有资源虽经测试，但仍无法保证所有资源可用性和破坏性，所有资源建议您在虚拟机内进行杀毒和测试，如因本站资源导致您的资料损失，硬件损坏等情况，本站概不负责。本站为导航网站，一旦通过链接跳出本站，所有第三方所提供的服务均与本站无本站一切原创内容在标注来源等情况下可自由转载，但对其自行开发的或和他人共同开发的所有内容、技术手段和服务拥有全部知识产权，任何人不得侵害或破坏，也不得擅自使用。资源均收集于互联网，仅限学习和研究目的，您不得将本站资源内容用于商业或非法用途，否则，一切后果请您自负。在网站收录网址的过程中，我们已经尽力去做到人工筛选，但不排除因信息差或收录内容协议有所变更，因此在使用第三方网址服务时，请注意谨防一切有违国家法律法规的不良行为。本网站提供的音乐播放器插件仅用于播放音乐资源，音乐版权和链接地址均归各大音乐平台所有，本站不存储、不分享、不转发任何音乐、音频、视频资源/文件（如MP3、MP4），本站用户在使用过程中出现任何法律纠纷等，一切和本站无关，本站不承担任何法律责任。……",
  Error: {
    Unauthorized:
